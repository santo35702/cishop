...
<div class="sidebar-menu">
	...
	<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
        <div class="menu">
			<ul id="menu" >
				<li><a href="<?php echo base_url(); ?>users"><i class="fa fa-tachometer"></i> <span>Home</span></a></li>
				<li><a href="<?php echo base_url(); ?>users/checkout"><i class="fa fa-cart-plus"></i> <span>Checkout</span></a></li>
